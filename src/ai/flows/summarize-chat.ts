...
/**
 * @fileOverview Summarizes a chat conversation using an AI model.
 *
...
const SummarizeChatInputSchema = z.object({
  chatLog: z
    .string()
    .describe('The complete chat log to be summarized. Include all messages in chronological order.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant tasked with summarizing chat logs.

  Given the following chat log, provide a concise and informative summary:
